...
$(function () {
    ...
    var targetAnchor;
    //$.each ($('ul.acc-menu a'), function() {//modified by z
    $.each ($('ul.acc-menu a,ul.mem-menu a'), function() {
       //console.log(this.href);
    	if(window.location.href.indexOf(this.href) == 0 ) {
            //if( this.href == window.location ) { //modified by zzdong
            targetAnchor = this;
            return false;
        }
    });
    ...
    $(parent).closest("li.dropdown").addClass('active');
