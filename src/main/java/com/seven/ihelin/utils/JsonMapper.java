...
public class JsonMapper {
    ...
    /**
     * 创建只输出初始值被改变的属性到Json字符串的Mapper, �?��约的存储方式，建议在内部接口中使用�?
     */
     ...
     * 如果JSON字符串为Null 返回Null. 如果JSON字符串为"[]", 返回空集
    ...
    /**
     * 構�?泛型的Collection Type�? ArrayList<MyBean>,
     * 则调用constructCollectionType(ArrayList.class,MyBean.class) HashMap
     * <String,MyBean>, 则调�?HashMap.class,String.class, MyBean.class)
     */
